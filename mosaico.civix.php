 ...
 * extension.
 */
class CRM_Mosaico_ExtensionUtil {
  const SHORT_NAME = "mosaico";
  const LONG_NAME = "uk.co.vedaconsulting.mosaico";
  const CLASS_PREFIX = "CRM_Mosaico";
 ...
 */
function _mosaico_civix_civicrm_config(&$config = NULL) {
 ...
 */
function _mosaico_civix_civicrm_install() {
 ...
 */
function _mosaico_civix_civicrm_uninstall() {
  _mosaico_civix_civicrm_config();
  if ($upgrader = _mosaico_civix_upgrader()) {
 ...
 */
function _mosaico_civix_civicrm_enable() {
  _mosaico_civix_civicrm_config();
  if ($upgrader = _mosaico_civix_upgrader()) {
 ...
 * @return mixed
 */
function _mosaico_civix_civicrm_disable() {
  _mosaico_civix_civicrm_config();
  if ($upgrader = _mosaico_civix_upgrader()) {
 ...
 */
function _mosaico_civix_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  if ($upgrader = _mosaico_civix_upgrader()) {
...
/**
 * @return CRM_Mosaico_Upgrader
 */
function _mosaico_civix_upgrader() {
  if (!file_exists(__DIR__ . '/CRM/Mosaico/Upgrader.php')) {
    return NULL;
  }
  else {
    return CRM_Mosaico_Upgrader_Base::instance();
  }
}
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _mosaico_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item, $key);
      }
    }
    return $found;
  }
